...
na("String.prototype.startsWith",function(a){return a?a:function(b,c){var d=oa(this,b,"startsWith");b+="";for(var e=d.length,f=b.length,k=Math.max(0,Math.min(c|0,d.length)),g=0;g<f&&k<e;)if(d[k++]!=b[g++])return!1;return g>=f}});
...
na("WeakMap",function(a){function b(h){this.f=(g+=Math.random()+1).toString();if(h){h=ba(h);for(var l;!(l=h.next()).done;)l=l.value,this.set(l[0],l[1])}}
function c(){}
function d(h){var l=typeof h;return"object"===l&&null!==h||"function"===l}
function e(h){if(!ua(h,k)){var l=new c;ka(h,k,{value:l})}}
...
function c(g,h){var l=g.f;return ta(function(){if(l){for(;l.head!=g.f;)l=l.previous;for(;l.next!=l.head;)return l=l.next,{done:!1,value:h(l)};l=null}return{done:!0,value:void 0}})}
...
function e(g){this.g={};this.f=b();this.size=0;if(g){g=ba(g);for(var h;!(h=g.next()).done;)h=h.value,this.set(h[0],h[1])}}
if(function(){if(!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var g=Object.seal({x:4}),h=new a(ba([[g,"s"]]));if("s"!=h.get(g)||1!=h.size||h.get({x:4})||h.set({x:4},"t")!=h||2!=h.size)return!1;var l=h.entries(),p=l.next();if(p.done||p.value[0]!=g||"s"!=p.value[1])return!1;p=l.next();return p.done||4!=p.value[0].x||"t"!=p.value[1]||!l.next().done?!1:!0}catch(q){return!1}}())return a;
sa();var f=new WeakMap;e.prototype.set=function(g,h){g=0===g?0:g;var l=d(this,g);l.list||(l.list=this.g[l.id]=[]);l.C?l.C.value=h:(l.C={next:this.f,previous:this.f.previous,head:this.f,key:g,value:h},l.list.push(l.C),this.f.previous.next=l.C,this.f.previous=l.C,this.size++);return this};
...
return b});
na("Object.entries",function(a){return a?a:function(b){var c=[],d;for(d in b)ua(b,d)&&c.push([d,b[d]]);return c}});
...
function b(q){for(var r=k,t=0;64>t;t+=4)r[t/4]=q[t]<<24|q[t+1]<<16|q[t+2]<<8|q[t+3];for(t=16;80>t;t++)q=r[t-3]^r[t-8]^r[t-14]^r[t-16],r[t]=(q<<1|q>>>31)&4294967295;q=e[0];var v=e[1],Q=e[2],F=e[3],Va=e[4];for(t=0;80>t;t++){if(40>t)if(20>t){var ea=F^v&(Q^F);var xa=1518500249}else ea=v^Q^F,xa=1859775393;else 60>t?(ea=v&Q|F&(v|Q),xa=2400959708):(ea=v^Q^F,xa=3395469782);ea=((q<<5|q>>>27)&4294967295)+ea+Va+xa+r[t]&4294967295;Va=F;F=Q;Q=(v<<30|v>>>2)&4294967295;v=q;q=ea}e[0]=e[0]+q&4294967295;e[1]=e[1]+
v&4294967295;e[2]=e[2]+Q&4294967295;e[3]=e[3]+F&4294967295;e[4]=e[4]+Va&4294967295}
...
if(v.length){var Va="loaded_"+J.I++;Zd[Va]=function(ea){Q[F](ea);Zd[Va]=null};
a=se(c,v,"gapi."+Va,h);h.push.apply(h,v);ie("ml0",v,t);b.sync||Sd.___gapisync?Fe(a):Ge(a)}else Q[F](Vd)}else d(v)&&e&&e()}
...
function vf(a){if(Ba(a))return Wa(a);a=tf(a);var b=[];uf(a,function(c){b.push(c)});
return b}
...
function Qg(){}
Pg.prototype=ca(Qg.prototype);Pg.prototype.constructor=Pg;if(ja)ja(Pg,Qg);else for(var Rg in Qg)if("prototype"!=Rg)if(Object.defineProperties){var Sg=Object.getOwnPropertyDescriptor(Qg,Rg);Sg&&Object.defineProperty(Pg,Rg,Sg)}else Pg[Rg]=Qg[Rg];Pg.A=Qg.prototype;function Tg(a,b,c){isNaN(c)&&(c=void 0);var d=u("yt.scheduler.instance.addJob");d?d(a,b,c):void 0===c?a():P(a,c||0)}
...
function Mi(){for(var a={},b=ba(Object.entries(Ah(O("DEVICE","")))),c=b.next();!c.done;c=b.next()){var d=ba(c.value);c=d.next().value;d=d.next().value;"cbrand"==c?a.deviceMake=d:"cmodel"==c?a.deviceModel=d:"cbr"==c?a.browserName=d:"cbrver"==c?a.browserVersion=d:"cos"==c?a.osName=d:"cosver"==c?a.osVersion=d:"cplatform"==c&&(a.platform=d)}return a}
...
x("yt_logging_screen.setCurrentScreen",function(a,b,c,d){c=void 0===c?0:c;if(a!==O(Lj(c))||b!==O(Mj(c)))Pj(a,d,c),vg(Lj(c),a),vg(Mj(c),b),0==c&&(b=function(){setTimeout(function(){if(a){var e={clientDocumentNonce:Kj,clientScreenNonce:a};var f=void 0===f?{}:f;var k={};k.eventTimeMs=Math.round(f.timestamp||ui());k.foregroundHeartbeatScreenAssociated=e;e=String;if(f.timestamp)var g=-1;else g=u("_lact",window),g=null==g?-1:Math.max(Ka()-g,0);k.context={lastActivityMs:e(g)};qi("log_sequence_info_on_gel_web")&&
f.Fa&&(e=k.context,g=f.Fa,Ri[g]=g in Ri?Ri[g]+1:0,e.sequence={index:Ri[g],groupKey:g},f.Rb&&delete Ri[f.Fa]);(f=f.Qb)?(e={},f.videoId?e.videoId=f.videoId:f.playlistId&&(e.playlistId=f.playlistId),Ii[f.token]=e,f=Ni("log_event",f.token)):f=Ni("log_event");f.push(k);uj&&(Ci.log_event=new uj);k=si("web_logging_max_batch")||100;e=ui();f.length>=k?Ki():10<=e-Fi&&(Qi(),Fi=e)}},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())});function Qj(){uh.call(this,"button");this.f=null;this.i=[];this.g={}}
...
function pk(a,b){if(b){var c=[];c.push(b);var d=wk(a,b);d&&(d=Hc(X(a),d),d=Wa(d),c=c.concat(d),z(c,function(e){uk(this,e)&&Ak(this,e)},a))}}
...
function zl(a){Al(Wa(a.f))}
function Bl(a){Cl(Wa(a.f))}
