...
;var Jc=(new Date).getTime();function Lc(a){if(!a)return"";a=a.split("#")[0].split("?")[0];a=a.toLowerCase();0==a.indexOf("//")&&(a=window.location.protocol+a);/^[\w\-]*:\/\//.test(a)||(a=window.location.href);var b=a.substring(a.indexOf("://")+3),c=b.indexOf("/");-1!=c&&(b=b.substring(0,c));a=a.substring(0,a.indexOf("://"));if("http"!==a&&"https"!==a&&"chrome-extension"!==a&&"file"!==a&&"android-app"!==a&&"chrome-search"!==a&&"app"!==a)throw Error("Invalid URI scheme in origin: "+a);c="";var d=b.indexOf(":");if(-1!=d){var e=
b.substring(d+1);b=b.substring(0,d);if("http"===a&&"80"!==e||"https"===a&&"443"!==e)c=":"+e}return a+"://"+b+c}
;function Mc(){function a(){e[0]=1732584193;e[1]=4023233417;e[2]=2562383102;e[3]=271733878;e[4]=3285377520;m=l=0}
function b(p){for(var v=g,r=0;64>r;r+=4)v[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=v[r-3]^v[r-8]^v[r-14]^v[r-16],v[r]=(p<<1|p>>>31)&4294967295;p=e[0];var B=e[1],K=e[2],ma=e[3],Kc=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ga=ma^B&(K^ma);var Ib=1518500249}else Ga=B^K^ma,Ib=1859775393;else 60>r?(Ga=B&K|ma&(B|K),Ib=2400959708):(Ga=B^K^ma,Ib=3395469782);Ga=((p<<5|p>>>27)&4294967295)+Ga+Kc+Ib+v[r]&4294967295;Kc=ma;ma=K;K=(B<<30|B>>>2)&4294967295;B=p;p=Ga}e[0]=e[0]+p&4294967295;e[1]=
e[1]+B&4294967295;e[2]=e[2]+K&4294967295;e[3]=e[3]+ma&4294967295;e[4]=e[4]+Kc&4294967295}
...
var Gf=z("ytLoggingTransportDispatchedStats_")||{};y("ytLoggingTransportDispatchedStats_",Gf,void 0);y("ytytLoggingTransportCapturedTime_",z("ytLoggingTransportCapturedTime_")||{},void 0);
function Hf(){T(Bf);T(Cf);Cf=0;if(!$a(V)){for(var a in V){var b=Af[a];if(b&&b.isReady()){var c=void 0,d=a,e=b,f=xf[d],g=Gf[d]||{};Gf[d]=g;b=Math.round(U());for(c in V[d]){var h=db,k=e.f||If();k={client:{hl:k.Ia,gl:k.Ha,clientName:k.Ga,clientVersion:k.innertubeContextClientVersion,configInfo:k.Fa}};var l=window.devicePixelRatio;l&&1!=l&&(k.client.screenDensityFloat=String(l));l=Q("EXPERIMENTS_TOKEN","");""!==l&&(k.client.experimentsToken=l);var m=l=void 0,p=[],v=Q("EXPERIMENTS_FORCED_FLAGS",{});for(m in v)p.push({key:m,
...
p),l={serializedEventId:l,clientCounter:p},k.serializedClientEventId=l,vf&&wf&&R("log_gel_rtt_web")&&(k.previousBatchInfo={serializedClientEventId:vf,roundtripMs:wf}),vf=l,wf=0;Lf(e,d,h,{retry:zf.has(d),onSuccess:Ka(Mf,U())})}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?((c.averageTimeBetweenDispatchesMs||0)*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete V[a];Ef=!1}}$a(V)||Nf()}}
function Nf(){R("web_gel_timeout_cap")&&!Cf&&(Cf=S(Hf,6E4));T(Bf);var a=Q("LOGGING_BATCH_TIMEOUT",Je("web_gel_debounce_ms",1E4));R("shorten_initial_gel_batch_timeout")&&Ef&&(a=tf);Bf=S(Hf,a)}
function Kf(a,b){b=void 0===b?"":b;V[a]=V[a]||{};V[a][b]=V[a][b]||[];return V[a][b]}
function Mf(a){wf=Math.round(U()-a)}
;var Of=0;y("ytDomDomGetNextId",z("ytDomDomGetNextId")||function(){return++Of},void 0);var Pf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
Qf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Za=z("ytEventsEventsListeners")||{};y("ytEventsEventsListeners",Za,void 0);var Sf=z("ytEventsEventsCounter")||{count:0};y("ytEventsEventsCounter",Sf,void 0);
...
var Uf=Va(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function W(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Tf(a,b,c,d);if(e)return e;e=++Sf.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new Qf(h);if(!Ac(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new Qf(h);
h.currentTarget=a;return c.call(a,h)};
g=te(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Uf()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);Za[e]=[a,b,c,g,d];return e}
function Vf(a){a&&("string"==typeof a&&(a=[a]),F(a,function(b){if(b in Za){var c=Za[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Uf()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete Za[b]}}))}
...
D(Xf,M);Xf.prototype.F=function(a){void 0===a.f&&Rf(a);var b=a.f;void 0===a.g&&Rf(a);this.f=new rc(b,a.g)};
Xf.prototype.A=function(){if(this.f){var a=Wf();if(0!=this.j){var b=this.m,c=this.f,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.j);this.h[this.i]=.5<Math.abs((d-this.l)/this.l)?1:0;for(c=b=0;4>c;c++)b+=this.h[c]||0;3<=b&&this.w();this.l=d}this.j=a;this.m=this.f;this.i=(this.i+1)%4}};
Xf.prototype.o=function(){window.clearInterval(this.K);Vf(this.D)};function Yf(){}
function Zf(a,b){return $f(a,1,b)}
;function ag(){}
t(ag,Yf);function $f(a,b,c){isNaN(c)&&(c=void 0);var d=z("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):S(a,c||0)}
ag.prototype.start=function(){var a=z("yt.scheduler.instance.start");a&&a()};
ag.prototype.pause=function(){var a=z("yt.scheduler.instance.pause");a&&a()};
ya(ag);ag.getInstance();var bg={};
function cg(a){var b=void 0===a?{}:a;a=void 0===b.Ea?!0:b.Ea;b=void 0===b.Qa?!1:b.Qa;if(null==z("_lact",window)){var c=parseInt(Q("LACT"),10);c=isFinite(c)?C()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&dg();W(document,"keydown",dg);W(document,"keyup",dg);W(document,"mousedown",dg);W(document,"mouseup",dg);a&&(b?W(window,"touchmove",function(){eg("touchmove",200)},{passive:!0}):(W(window,"resize",function(){eg("resize",200)}),W(window,"scroll",function(){eg("scroll",200)})));
new Xf(function(){eg("mouse",100)});
W(document,"touchstart",dg,{passive:!0});W(document,"touchend",dg,{passive:!0})}}
function eg(a,b){bg[a]||(bg[a]=!0,Zf(function(){dg();bg[a]=!1},b))}
function dg(){null==z("_lact",window)&&cg();var a=C();y("_lact",a,window);-1==z("_fact",window)&&y("_fact",a,window);(a=z("ytglobal.ytUtilActivityCallback_"))&&a()}
function fg(){var a=z("_lact",window);return null==a?-1:Math.max(C()-a,0)}
;var gg=z("ytLoggingGelSequenceIdObj_")||{};y("ytLoggingGelSequenceIdObj_",gg,void 0);
function hg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||U());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:fg())};R("log_sequence_info_on_gel_web")&&d.P&&(a=e.context,b=d.P,gg[b]=b in gg?gg[b]+1:0,a.sequence={index:gg[b],groupKey:b},d.sb&&delete gg[d.P]);(d=d.da)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),Ff[d.token]=a,d=Kf("log_event",d.token)):d=Kf("log_event");d.push(e);c&&(Af.log_event=new c);c=Je("web_logging_max_batch")||
100;e=U();d.length>=c?Hf():10<=e-Df&&(Nf(),Df=e)}
;function ig(){return"INNERTUBE_API_KEY"in ne&&"INNERTUBE_API_VERSION"in ne}
function Jf(){for(var a={},b=q(Object.entries(Be(Q("DEVICE","")))),c=b.next();!c.done;c=b.next()){var d=q(c.value);c=d.next().value;d=d.next().value;"cbrand"==c?a.deviceMake=d:"cmodel"==c?a.deviceModel=d:"cbr"==c?a.browserName=d:"cbrver"==c?a.browserVersion=d:"cos"==c?a.osName=d:"cosver"==c?a.osVersion=d:"cplatform"==c&&(a.platform=d)}return a}
...
function jg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.pb||Q("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().ob:b=Pc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
;function lg(a,b,c,d){nc.set(""+a,b,{ma:c,path:"/",domain:void 0===d?"youtube.com":d,secure:!1})}
;function mg(){var a=new fe;(a=a.isAvailable()?new le(a,"yt.innertube"):null)||(a=new ge("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new be(a):null;this.g=document.domain||window.location.hostname}
mg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,C()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(yd(b))}catch(f){return}else e=escape(b);lg(a,e,c,this.g)};
mg.prototype.get=function(a,b){var c=void 0,d=!this.f;if(!d)try{c=this.f.get(a)}catch(e){d=!0}if(d&&(c=nc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
mg.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;nc.remove(""+a,"/",void 0===b?"youtube.com":b)};var ng=new mg;function og(a,b,c,d){if(d)return null;d=ng.get("nextId",!0)||1;var e=ng.get("requests",!0)||{};e[d]={method:a,request:b,authState:kg(c),requestTime:Math.round(U())};ng.set("nextId",d+1,86400,!0);ng.set("requests",e,86400,!0);return d}
function pg(a){var b=ng.get("requests",!0)||{};delete b[a];ng.set("requests",b,86400,!0)}
function qg(a){var b=ng.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=kg(jg(!1));bb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),Lf(a,d.method,e,{}));delete b[c]}}ng.set("requests",b,86400,!0)}}
;function rg(a){var b=this;this.f=null;a?this.f=a:ig()&&(this.f=If());$f(function(){qg(b)},0,5E3)}
rg.prototype.isReady=function(){!this.f&&ig()&&(this.f=If());return!!this.f};
function Lf(a,b,c,d){!Q("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&ve(Error("Missing VISITOR_DATA when sending innertube request."));var e={headers:{"Content-Type":"application/json"},method:"POST",C:c,ra:"JSON",O:function(){d.O()},
...
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Ja;g&&(f=g);g=a.f.Ka||!1;var h=jg(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=Ce(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),l;if(d.retry&&R("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=og(b,c,h,g))){var m=e.onSuccess,p=e.oa;e.onSuccess=function(v,r){pg(l);m(v,r)};
c.oa=function(v,r){pg(l);p(v,r)}}try{R("use_fetch_for_op_xhr")?Te(k,e):(e.method="POST",e.C||(e.C={}),We(k,e))}catch(v){if("InvalidAccessError"==v)l&&(pg(l),l=0),ve(Error("An extension is blocking network request."));
else throw v;}l&&$f(function(){qg(a)},0,5E3)}
;function sg(a,b,c){c=void 0===c?{}:c;var d=rg;Q("ytLoggingEventsDefaultDisabled",!1)&&rg==rg&&(d=null);hg(a,b,d,c)}
;function tg(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:ba(q(c)))}
t(tg,Error);var ug=new Set,vg=0;function wg(a){var b=z("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,!1,void 0):(b=oe(),b.push([a,"ERROR",void 0,void 0,!1,void 0]),P("ERRORS",b))}
function xg(a){var b=z("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,!1,void 0):(b=oe(),b.push([a,"WARNING",void 0,void 0,!1,void 0]),P("ERRORS",b))}
function yg(a,b,c,d){c+="."+a;a=String(JSON.stringify(b)).substr(0,500);d[c]=a;return c.length+a.length}
;function zg(a,b,c,d,e,f){b=void 0===b?"ERROR":b;f=void 0===f?{}:f;f.name=c||Q("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||Q("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);c=f||{};d=void 0===b?"ERROR":b;d=void 0===d?"ERROR":d;f=window&&window.yterr||!1;if(a&&f&&!(5<=vg)&&(R("console_log_js_exceptions")&&(f=[],f.push("Name: "+a.name),f.push("Message: "+a.message),a.hasOwnProperty("params")&&f.push("Error Params: "+JSON.stringify(a.params)),f.push("File name: "+a.fileName),f.push("Stacktrace: "+a.stack),
window.console.log(f.join("\n"),a)),0!==a.f)){f=a.g;b=a.columnNumber;if(a.args&&a.args.length)for(var g=0,h=0;h<a.args.length;h++){e=a.args[h];var k="params."+h;g+=k.length;if(e)if(Array.isArray(e))for(var l=c,m=0;m<e.length&&!(e[m]&&(g+=yg(m,e[m],k,l),500<g));m++);else if("object"===typeof e)for(l in l=void 0,m=c,e){if(e[l]&&(g+=yg(l,e[l],k,m),500<g))break}else c[k]=String(JSON.stringify(e)).substring(0,500),g+=c[k].length;else c[k]=String(JSON.stringify(e)).substring(0,500),g+=c[k].length;if(500<=
...
(a.params=c,window.yterr(a));if(!(ug.has(a.message)||0<=f.indexOf("/YouTubeCenter.js")||0<=f.indexOf("/mytube.js"))){R("kevlar_gel_error_routing")&&(b=d,k={level:"ERROR_LEVEL_UNKNOWN"},"ERROR"===b?k.level="ERROR_LEVEL_ERROR":"WARNING"===b&&(k.level="ERROR_LEVEL_WARNNING"),sg("clientError",{errorMetadata:{pageUrl:window.location.href},stackTrace:{isObfuscated:!0,browserStackInfo:e},logMessage:k}));d={bb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:h,level:d,"client.name":c.name},
C:{url:Q("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};c.version&&(d["client.version"]=c.version);if(d.C){f&&(d.C.stack=f);f=q(Object.keys(c));for(b=f.next();!b.done;b=f.next())b=b.value,d.C["client."+b]=c[b];if(c=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(f=q(Object.keys(c)),b=f.next();!b.done;b=f.next())b=b.value,d.C[b]=c[b]}We(Q("ECATCHER_REPORT_HOST","")+"/error_204",d);ug.add(a.message);vg++}}}
;var Ag=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};y("yt.msgs_",Ag,void 0);function Bg(a){me(Ag,arguments)}
;function Cg(a){a&&(a.dataset?a.dataset[Dg("loaded")]="true":a.setAttribute("data-loaded","true"))}
function Eg(a,b){return a?a.dataset?a.dataset[Dg(b)]:a.getAttribute("data-"+b):null}
var Fg={};function Dg(a){return Fg[a]||(Fg[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Gg=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Hg=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function Ig(a,b,c){c=void 0===c?null:c;if(window.spf&&spf.script){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(Gg,""),c=c.replace(Hg,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else Jg(a,b,c)}
function Jg(a,b,c){c=void 0===c?null:c;var d=Kg(a),e=document.getElementById(d),f=e&&Eg(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=mf(d,b),b=""+Ea(b),Lg[b]=f),g||(e=Mg(a,d,function(){Eg(e,"loaded")||(Cg(e),pf(d),S(Ka(qf,d),0))},c)))}
function Mg(a,b,c,d){d=void 0===d?null:d;var e=xc(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Ng(a){a=Kg(a);var b=document.getElementById(a);b&&(qf(a),b.parentNode.removeChild(b))}
function Og(a,b){if(a&&b){var c=""+Ea(b);(c=Lg[c])&&of(c)}}
function Kg(a){var b=document.createElement("a");Mb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Pb(a)}
var Lg={};var Pg=[],Qg=!1;function Rg(){if("1"!=Xa(pe(),"args","privembed")){var a=function(){Qg=!0;"google_ad_status"in window?P("DCLKSTAT",1):P("DCLKSTAT",2)};
Ig("//static.doubleclick.net/instream/ad_status.js",a);Pg.push(Zf(function(){Qg||"google_ad_status"in window||(Og("//static.doubleclick.net/instream/ad_status.js",a),Qg=!0,P("DCLKSTAT",3))},5E3))}}
function Sg(){return parseInt(Q("DCLKSTAT",0),10)}
;function Tg(){this.g=!1;this.f=null}
Tg.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,Ig(b,function(){g.g=!1;window.botguard?Ug(g,c,d,f):(Ng(b),xg(new tg("Unable to load Botguard","from "+b)))},e)):a&&(eval(a),window.botguard?Ug(this,c,d,f):xg(Error("Unable to load Botguard from JS")))};
function Ug(a,b,c,d){if(d)try{a.f=new window.botguard.bg(b,c?function(){return c(b)}:xa)}catch(e){xg(e)}else{try{a.f=new window.botguard.bg(b)}catch(e){xg(e)}c&&c(b)}}
Tg.prototype.dispose=function(){this.f=null};var Vg=new Tg,Wg=!1,Xg=0,Yg="";function Zg(a){R("botguard_periodic_refresh")?Xg=U():R("botguard_always_refresh")&&(Yg=a)}
function $g(a){if(a){if(Vg.g)return!1;if(R("botguard_periodic_refresh"))return 72E5<U()-Xg;if(R("botguard_always_refresh"))return Yg!=a}else return!1;return!Wg}
function ah(){return!!Vg.f}
function bh(a){a=void 0===a?{}:a;a=void 0===a?{}:a;return Vg.f?Vg.f.invoke(void 0,void 0,a):null}
;var ch=C().toString();
function dh(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=C();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(ch)for(a=1,b=0;b<ch.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^ch.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var eh=z("ytLoggingTimeDocumentNonce_")||dh();y("ytLoggingTimeDocumentNonce_",eh,void 0);var fh=1;function gh(a){this.f=a}
function hh(a){var b={};void 0!==a.f.trackingParams?b.trackingParams=a.f.trackingParams:(b.veType=a.f.veType,void 0!==a.f.veCounter&&(b.veCounter=a.f.veCounter),void 0!==a.f.elementIndex&&(b.elementIndex=a.f.elementIndex));void 0!==a.f.dataElement&&(b.dataElement=hh(a.f.dataElement));void 0!==a.f.youtubeData&&(b.youtubeData=a.f.youtubeData);return b}
gh.prototype.toString=function(){return JSON.stringify(hh(this))};function ih(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function jh(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function kh(a){return Q(jh(void 0===a?0:a),void 0)}
y("yt_logging_screen.getRootVeType",kh,void 0);function lh(){var a=kh(0),b;a?b=new gh({veType:a,youtubeData:void 0}):b=null;return b}
function mh(){var a=Q("csn-to-ctt-auth-info");a||(a={},P("csn-to-ctt-auth-info",a));return a}
function nh(a){a=void 0===a?0:a;var b=Q(ih(a));if(!b&&!Q("USE_CSN_FALLBACK",!0))return null;b||0!=a||(R("kevlar_client_side_screens")||R("c3_client_side_screens")?b="UNDEFINED_CSN":b=Q("EVENT_ID"));return b?b:null}
y("yt_logging_screen.getCurrentCsn",nh,void 0);function oh(a,b,c){var d=mh();(c=nh(c))&&delete d[c];b&&(d[a]=b)}
function ph(a){return mh()[a]}
y("yt_logging_screen.getCttAuthInfo",ph,void 0);function qh(a,b,c,d){c=void 0===c?0:c;if(a!==Q(ih(c))||b!==Q(jh(c)))oh(a,d,c),P(ih(c),a),P(jh(c),b),0==c&&(b=function(){setTimeout(function(){a&&hg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:eh,clientScreenNonce:a},rg)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
y("yt_logging_screen.setCurrentScreen",qh,void 0);function rh(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=I(J(3,window.location.href));g&&f.push(g);g=I(J(3,d));if(0<=Na(f,g)||!g&&0==d.lastIndexOf("/",0))if(R("autoescape_tempdata_url")&&(f=document.createElement("a"),Mb(f,d),d=f.href),d){g=d.match(Qb);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
b.ved)&&(b=Object.assign({csn:nh()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Pb(d).toString(36),e=e?Sb(e):"",lg(b,e,k||5))}else k=b,e="ST-"+Pb(d).toString(36),k=k?Sb(k):"",lg(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var p=void 0===p?window:p;c=p.location;a=Tb(a,l)+m;a=a instanceof G?a:Cb(a);c.href=Ab(a)}return!0}
;function sh(a,b){this.version=a;this.args=b}
;function th(a,b){this.topic=a;this.f=b}
th.prototype.toString=function(){return this.topic};var uh=z("ytPubsub2Pubsub2Instance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.N;O.prototype.publish=O.prototype.M;O.prototype.clear=O.prototype.clear;y("ytPubsub2Pubsub2Instance",uh,void 0);var vh=z("ytPubsub2Pubsub2SubscribedKeys")||{};y("ytPubsub2Pubsub2SubscribedKeys",vh,void 0);var wh=z("ytPubsub2Pubsub2TopicToKeys")||{};y("ytPubsub2Pubsub2TopicToKeys",wh,void 0);var xh=z("ytPubsub2Pubsub2IsAsync")||{};y("ytPubsub2Pubsub2IsAsync",xh,void 0);
y("ytPubsub2Pubsub2SkipSubKey",null,void 0);function yh(a,b){var c=zh();c&&c.publish.call(c,a.toString(),a,b)}
function Ah(a){var b=Bh,c=zh();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=z("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(vh[d])try{if(f&&b instanceof th&&b!=e)try{var h=b.f,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.H){var l=new h;h.H=l.version}var m=h.H}catch(p){}if(!m||k.version!=m)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
Ta(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){ue(p)}},xh[b.toString()]?z("yt.scheduler.instance")?Zf(g):S(g,0):g())});
vh[d]=!0;wh[b.toString()]||(wh[b.toString()]=[]);wh[b.toString()].push(d);return d}
function Ch(){var a=Dh,b=Ah(function(c){a.apply(void 0,arguments);Eh(b)});
return b}
function Eh(a){var b=zh();b&&("number"===typeof a&&(a=[a]),F(a,function(c){b.unsubscribeByKey(c);delete vh[c]}))}
function zh(){return z("ytPubsub2Pubsub2Instance")}
;function Fh(a){sh.call(this,1,arguments);this.csn=a}
t(Fh,sh);var Bh=new th("screen-created",Fh),Gh=[],Hh=0;function Ih(a,b,c){b={csn:a,parentVe:hh(b),childVes:Pa(c,function(e){return hh(e)})};
c=q(c);for(var d=c.next();!d.done;d=c.next())d=hh(d.value),($a(d)||!d.trackingParams&&!d.veType)&&zg(Error("Child VE logged with no data"),"WARNING");c={da:ph(a),P:a};"UNDEFINED_CSN"==a?Jh("visualElementAttached",b,c):hg("visualElementAttached",b,rg,c)}
function Jh(a,b,c){Gh.push({Pa:a,payload:b,options:c});Hh||(Hh=Ch())}
function Dh(a){if(Gh){for(var b=q(Gh),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,hg(c.Pa,c.payload,null,c.options));Gh.length=0}Hh=0}
;function Kh(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||cb(b);this.assets=a.assets||{};this.attrs=a.attrs||cb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Kh.prototype.clone=function(){var a=new Kh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==za(c)?a[b]=cb(c):a[b]=c}return a};function Lh(){M.call(this);this.f=[]}
t(Lh,M);Lh.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.qb)}M.prototype.o.call(this)};var Mh=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Nh(a){a=a||"";if(window.spf){var b=a.match(Mh);spf.style.load(a,b?b[1]:"",void 0)}else Oh(a)}
function Oh(a){var b=Ph(a),c=document.getElementById(b),d=c&&Eg(c,"loaded");d||c&&!d||(c=Qh(a,b,function(){Eg(c,"loaded")||(Cg(c),pf(b),S(Ka(qf,b),0))}))}
...
function Ph(a){var b=xc(document,"A");Mb(b,new G(yb,a));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Pb(a)}
;function Rh(a,b,c,d){M.call(this);var e=this;this.m=this.X=a;this.U=b;this.w=!1;this.api={};this.V=this.D=null;this.F=new O;id(this,Ka(jd,this.F));this.j={};this.R=this.W=this.h=this.ca=this.f=null;this.K=!1;this.l=this.A=null;this.Y={};this.ua=["onReady"];this.ba=null;this.ka=NaN;this.S={};this.i=d;Sh(this);this.Z("WATCH_LATER_VIDEO_ADDED",this.Ma.bind(this));this.Z("WATCH_LATER_VIDEO_REMOVED",this.Na.bind(this));this.Z("onAdAnnounce",this.wa.bind(this));this.va=new Lh(this);id(this,Ka(jd,this.va));
this.T=0;c?this.T=S(function(){e.loadNewVideoConfig(c)},0):d&&(Th(this),Uh(this))}
t(Rh,M);n=Rh.prototype;n.getId=function(){return this.U};
n.loadNewVideoConfig=function(a){if(!this.g){this.T&&(T(this.T),this.T=0);a instanceof Kh||(a=new Kh(a));this.ca=a;this.f=a.clone();Th(this);this.W||(this.W=Vh(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=Ic(Number(a)||a);if(a=this.f.attrs.height)this.m.style.height=Ic(Number(a)||a);Uh(this);this.w&&Wh(this)}};
function Th(a){var b;a.i?b=a.i.rootElementId:b=a.f.attrs.id;a.h=b||a.h;"video-player"==a.h&&(a.h=a.U,a.f.attrs.id=a.U);a.m.id==a.h&&(a.h+="-player",a.f.attrs.id=a.h)}
n.Ba=function(){return this.ca};
function Wh(a){a.f&&!a.f.loaded&&(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function Xh(a){var b=!0,c=Yh(a);c&&a.f&&(a=Zh(a),b=Eg(c,"version")===a);return b&&!!z("yt.player.Application.create")}
function Uh(a){if(!a.g&&!a.K){var b=Xh(a);if(b&&"html5"==(Yh(a)?"html5":null))a.R="html5",a.w||$h(a);else if(ai(a),a.R="html5",b&&a.l)a.X.appendChild(a.l),$h(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.A=function(){c=!0;if(a.i)var d=a.i.serializedExperimentFlags;else a.f&&a.f.args&&(d=a.f.args.fflags);d="true"==ze(d||"").player_bootstrap_method?z("yt.player.Application.createAlternate")||z("yt.player.Application.create"):z("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.X,e,a.i);$h(a)};
a.K=!0;b?a.A():(Ig(Zh(a),a.A),Nh(a.i?a.i.cssUrl:a.f.assets.css),bi(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function Yh(a){var b=tc(a.h);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.h));return b}
function $h(a){if(!a.g){var b=Yh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.K=!1,b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||ci(a)):a.ka=S(function(){$h(a)},50)}}
function ci(a){Sh(a);a.w=!0;var b=Yh(a);b.addEventListener&&(a.D=di(a,b,"addEventListener"));b.removeEventListener&&(a.V=di(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=di(a,b,e))}for(var f in a.j)a.D(f,a.j[f]);Wh(a);a.W&&a.W(a.api);a.F.M("onReady",a.api)}
function di(a,b,c){var d=b[c];return function(){try{return a.ba=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.ba=e,ve(e))}}}
function Sh(a){a.w=!1;if(a.V)for(var b in a.j)a.V(b,a.j[b]);for(var c in a.S)T(parseInt(c,10));a.S={};a.D=null;a.V=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.Z.bind(a);a.api.removeEventListener=a.Sa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Ca.bind(a);a.api.getPlayerType=a.Da.bind(a);a.api.getCurrentVideoConfig=a.Ba.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.La.bind(a)}
n.La=function(){return this.w};
n.Z=function(a,b){var c=this,d=Vh(this,b);if(d){if(!(0<=Na(this.ua,a)||this.j[a])){var e=ei(this,a);this.D&&this.D(a,e)}this.F.subscribe(a,d);"onReady"==a&&this.w&&S(function(){d(c.api)},0)}};
n.Sa=function(a,b){if(!this.g){var c=Vh(this,b);c&&Wd(this.F,a,c)}};
function Vh(a,b){var c=b;if("string"==typeof b){if(a.Y[b])return a.Y[b];c=function(){var d=z(b);d&&d.apply(x,arguments)};
a.Y[b]=c}return c?c:null}
function ei(a,b){var c="ytPlayer"+b+a.U;a.j[b]=c;x[c]=function(d){var e=S(function(){if(!a.g){a.F.M(b,d);var f=a.S,g=String(e);g in f&&delete f[g]}},0);
ab(a.S,String(e))};
return c}
...
n.Da=function(){return this.R||(Yh(this)?"html5":null)};
n.Ca=function(){return this.ba};
function ai(a){a.cancel();Sh(a);a.R=null;a.f&&(a.f.loaded=!1);var b=Yh(a);b&&(Xh(a)||!bi(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));for(a=a.X;b=a.firstChild;)a.removeChild(b)}
n.cancel=function(){this.A&&Og(Zh(this),this.A);T(this.ka);this.K=!1};
n.o=function(){ai(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){ue(b)}this.Y=null;for(var a in this.j)x[this.j[a]]=null;this.ca=this.f=this.api=null;delete this.X;delete this.m;M.prototype.o.call(this)};
function bi(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function Zh(a){return a.i?a.i.jsUrl:a.f.assets.js}
;var fi={},gi="player_uid_"+(1E9*Math.random()>>>0);function hi(a){delete fi[a.getId()]}
;function ii(a,b){sh.call(this,1,arguments)}
t(ii,sh);function ji(a,b){sh.call(this,1,arguments)}
t(ji,sh);var ki=new th("aft-recorded",ii),li=new th("timing-sent",ji);var mi=window;function ni(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var X=mi.performance||mi.mozPerformance||mi.msPerformance||mi.webkitPerformance||new ni;var oi=!1;function pi(a){var b=qi(a);if(b.aft)return b.aft;a=Q((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function ri(a){var b;(b=z("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},La("ytcsi."+(a||"")+"data_",b));return b}
function si(a){a=ri(a);a.info||(a.info={});return a.info}
function qi(a){a=ri(a);a.tick||(a.tick={});return a.tick}
function ti(a){var b=ri(a).nonce;b||(b=dh(),ri(a).nonce=b);return b}
function ui(a){var b=qi(a||""),c=pi(a);c&&!oi&&(yh(ki,new ii(Math.round(c-b._start),a)),oi=!0)}
;function vi(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!wi(a)||c.some(function(e){return!wi(e)}))throw Error("Only objects may be merged.");
c=q(c);for(d=c.next();!d.done;d=c.next())xi(a,d.value);return a}
function xi(a,b){for(var c in b)if(wi(b[c])){if(c in a&&!wi(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});xi(a[c],b[c])}else if(yi(b[c])){if(c in a&&!yi(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);zi(a[c],b[c])}else a[c]=b[c];return a}
function zi(a,b){for(var c=q(b),d=c.next();!d.done;d=c.next())d=d.value,wi(d)?a.push(xi({},d)):yi(d)?a.push(zi([],d)):a.push(d);return a}
function wi(a){return"object"===typeof a&&!Array.isArray(a)}
function yi(a){return"object"===typeof a&&Array.isArray(a)}
;function Ai(){var a=z("ytcsi.debug");a||(a=[],y("ytcsi.debug",a,void 0),y("ytcsi.reference",{},void 0));return a}
function Bi(a){a=a||"";var b=z("ytcsi.reference");b||(Ai(),b=z("ytcsi.reference"));if(b[a])return b[a];var c=Ai(),d={timerName:a,info:{},tick:{}};c.push(d);return b[a]=d}
;var Ci=z("ytLoggingLatencyUsageStats_")||{};y("ytLoggingLatencyUsageStats_",Ci,void 0);function Di(){this.f=0}
function Ei(){Di.instance||(Di.instance=new Di);return Di.instance}
Di.prototype.tick=function(a,b,c){Fi(this,"tick_"+a+"_"+b)||sg("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
Di.prototype.info=function(a,b){var c=Object.keys(a).join("");Fi(this,"info_"+c+"_"+b)||(a.clientActionNonce=b,sg("latencyActionInfo",a))};
function Fi(a,b){Ci[b]=Ci[b]||{count:0};var c=Ci[b];c.count++;c.time=U();a.f||(a.f=$f(function(){var d=U(),e;for(e in Ci)Ci[e]&&6E4<d-Ci[e].time&&delete Ci[e];a&&(a.f=0)},0,5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new tg("CSI data exceeded logging limit with key",b),0===b.indexOf("info")?xg(c):wg(c)),!0):!1}
;var Y={},Gi=(Y.ad_allowed="adTypesAllowed",Y.yt_abt="adBreakType",Y.ad_cpn="adClientPlaybackNonce",Y.ad_docid="adVideoId",Y.yt_ad_an="adNetworks",Y.ad_at="adType",Y.browse_id="browseId",Y.p="httpProtocol",Y.t="transportProtocol",Y.cpn="clientPlaybackNonce",Y.cseg="creatorInfo.creatorSegment",Y.csn="clientScreenNonce",Y.docid="videoId",Y.GetHome_rid="getHomeRequestId",Y.GetSearch_rid="getSearchRequestId",Y.GetPlayer_rid="getPlayerRequestId",Y.GetWatchNext_rid="getWatchNextRequestId",Y.GetBrowse_rid=
...
Y.GetTrending_rid="mwebInfo.getTrendingRequestId",Y.GetMusicSearchSuggestions_rid="musicInfo.getMusicSearchSuggestionsRequestId",Y),Hi="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),Ii={},Ji=(Ii.mver="MEASUREMENT_VERSION_",Ii.pis="PLAYER_INITIALIZED_STATE_",Ii.yt_pt=
"LATENCY_PLAYER_",Ii.pa="LATENCY_ACTION_",Ii.yt_vst="VIDEO_STREAM_TYPE_",Ii),Ki="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds GetLibrary_rid".split(" ");function Li(a){return!!Q("FORCE_CSI_ON_GEL",!1)||R("csi_on_gel")||!!ri(a).useGel}
function Mi(a){a=ri(a);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function Ni(a,b,c){if(null!==b)if(si(c)[a]=b,Li(c)){var d=Mi(c);if(d.gelInfos)d.gelInfos["info_"+a]=!0;else{var e={};d.gelInfos=(e["info_"+a]=!0,e)}if(a in Gi){d=Gi[a];0<=Na(Hi,d)&&(b=!!b);a in Ji&&"string"===typeof b&&(b=Ji[a]+b.toUpperCase());a=d.split(".");e=d={};for(var f=0;f<a.length-1;f++){var g=a[f];e[g]={};e=e[g]}e[a[a.length-1]]=b;b=vi({},d)}else 0<=Na(Ki,a)||xg(new tg("Unknown label logged with GEL CSI",a)),b=void 0;b&&Li(c)&&(a=Bi(c||""),vi(a.info,b),a=Mi(c),"gelInfos"in a||(a.gelInfos=
{}),vi(a.gelInfos,b),c=ti(c),Ei().info(b,c))}else Bi(c||"").info[a]=b}
if(R("overwrite_polyfill_on_logging_lib_loaded")){var Oi=window;Oi.ytcsi&&(Oi.ytcsi.info=Ni)};function Pi(a,b,c){var d=qi(c),e;if(e=R("use_first_tick"))e=qi(c),e=a in e;if(e)return d[a];b||"_"==a[0]||(e=a,X.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),X.mark(e)));e=b||U();d[a]=e;e=Mi(c);e.gelTicks&&(e.gelTicks["tick_"+a]=!0);c||b||U();if(Li(c)){Bi(c||"").tick[a]=b||U();e=ti(c);if("_start"===a){var f=Ei();Fi(f,"baseline_"+e)||sg("latencyActionBaselined",{clientActionNonce:e},{timestamp:b})}else Ei().tick(a,e,b);ui(c);e=!0}else e=!1;if(!e){if(!z("yt.timing."+(c||"")+
"pingSent_")&&(f=Q((c||"")+"TIMING_ACTION",void 0),e=qi(c),z("ytglobal.timing"+(c||"")+"ready_")&&f&&e._start&&pi(c)))if(ui(c),c)Qi(c);else{f=!0;var g=Q("TIMING_WAIT",[]);if(g.length)for(var h=0,k=g.length;h<k;++h)if(!(g[h]in e)){f=!1;break}f&&Qi(c)}Bi(c||"").tick[a]=b||U()}return d[a]}
function Qi(a){if(!Li(a)){var b=qi(a),c=si(a),d=b._start,e=Q("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:Q((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;if(c.h5jse){var h=window.location.protocol+z("ytplayer.config.assets.js");(h=X.getEntriesByName?X.getEntriesByName(h)[0]:void 0)?c.h5jse=Math.round(c.h5jse-h.responseEnd):delete c.h5jse}b.aft=pi(a);var k=qi(a);h=k.pbr;var l=k.vc;k=k.pbs;h&&l&&k&&h<l&&l<k&&si(a).yt_pvis&&"youtube"==e&&(Ni("yt_lt","hot_bg",a),e=b.vc,h=b.pbs,
...
c){var r=void 0===r?"":r;gf(f,r)||df(f,void 0,void 0,void 0,r)}else df(f);y("yt.timing."+(a||"")+"pingSent_",!0,void 0);yh(li,new ji(m.aft+(g||0),a))}}
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);var Ri=window;R("csi_on_gel")&&Ri.ytcsi&&(Ri.ytcsi.tick=Pi);function Si(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function Ti(a,b,c){"string"===typeof a&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});a:{if((b=a.mediaContentUrl)&&(b=/\/([ve]|embed)\/([^#?]+)/.exec(b))&&b[2]){b=b[2];break a}b=null}a.videoId=b;return Ui(a)}
function Ui(a,b,c){if("string"===typeof a)return{videoId:a,startSeconds:b,suggestedQuality:c};b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}
function Vi(a,b,c,d){if(Da(a)&&!Aa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function Wi(a){a=void 0===a?!1:a;M.call(this);this.f=new O(a);id(this,Ka(jd,this.f))}
D(Wi,M);Wi.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
Wi.prototype.j=function(a,b){this.g||this.f.M.apply(this.f,arguments)};function Xi(a,b,c){Wi.call(this);this.h=a;this.i=b;this.l=c}
t(Xi,Wi);function Yi(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(yd(a),d.i))}}
Xi.prototype.o=function(){this.i=this.h=null;Wi.prototype.o.call(this)};function Zi(a){M.call(this);this.f=a;this.f.subscribe("command",this.sa,this);this.h={};this.j=!1}
t(Zi,M);n=Zi.prototype;n.start=function(){this.j||this.g||(this.j=!0,Yi(this.f,"RECEIVING"))};
n.sa=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.h||(c=A(this.Ua,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&$i(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=aj(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=bj(a,c))&&this.j&&!this.g&&Yi(this.f,a,c))}}};
n.Ua=function(a,b){this.j&&!this.g&&Yi(this.f,a,this.fa(a,b))};
n.fa=function(a,b){if(null!=b)return{value:b}};
function $i(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
n.o=function(){var a=this.f;a.g||Wd(a.f,"command",this.sa,this);this.f=null;for(var b in this.h)$i(this,b);M.prototype.o.call(this)};function cj(a,b){Zi.call(this,b);this.i=a;this.start()}
t(cj,Zi);cj.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
cj.prototype.removeEventListener=function(a,b){this.i.removeEventListener(a,b)};
function aj(a,b){switch(a){case "loadVideoById":return b=Ui(b),[b];case "cueVideoById":return b=Ui(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=Vi(b),[b];case "cuePlaylist":return b=Vi(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
case "setShuffle":return[b.shufflePlaylist];case "getOptions":return[b.module];case "getOption":return[b.module,b.option];case "setOption":return[b.module,b.option,b.value];case "handleGlobalKeyDown":return[b.keyCode,b.shiftKey,b.ctrlKey,b.altKey,b.metaKey,b.key,b.code]}return[]}
function bj(a,b){switch(a){case "isMuted":return{muted:b};case "getVolume":return{volume:b};case "getPlaybackRate":return{playbackRate:b};case "getAvailablePlaybackRates":return{availablePlaybackRates:b};case "getVideoLoadedFraction":return{videoLoadedFraction:b};case "getPlayerState":return{playerState:b};case "getCurrentTime":return{currentTime:b};case "getPlaybackQuality":return{playbackQuality:b};case "getAvailableQualityLevels":return{availableQualityLevels:b};case "getDuration":return{duration:b};
case "getVideoUrl":return{videoUrl:b};case "getVideoEmbedCode":return{videoEmbedCode:b};case "getPlaylist":return{playlist:b};case "getPlaylistIndex":return{playlistIndex:b};case "getOptions":return{options:b};case "getOption":return{option:b}}}
cj.prototype.fa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Zi.prototype.fa.call(this,a,b)};
cj.prototype.o=function(){Zi.prototype.o.call(this);delete this.i};function dj(a,b,c){M.call(this);var d=this;c=c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.w="*";this.i=c;this.sessionId=null;this.channel="widget";this.A=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.A&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
t(dj,M);dj.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.w)}catch(e){ve(e)}}};
dj.prototype.o=function(){window.removeEventListener("message",this.m);M.prototype.o.call(this)};function ej(){var a=this.g=new dj(!!Q("WIDGET_ID_ENFORCE")),b=A(this.Ra,this);a.j=b;a.l=null;this.g.channel="widget";if(a=Q("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
n=ej.prototype;n.Ra=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,fj(this,a)),this.j[a]=!0)):this.na(a,b,c)};
n.na=function(){};
function fj(a,b){return A(function(c){this.sendMessage(b,c)},a)}
...
n.dispose=function(){this.g=null};function hj(a){ej.call(this);this.f=a;this.h=[];this.addEventListener("onReady",A(this.Oa,this));this.addEventListener("onVideoProgress",A(this.Ya,this));this.addEventListener("onVolumeChange",A(this.Za,this));this.addEventListener("onApiChange",A(this.Ta,this));this.addEventListener("onPlaybackQualityChange",A(this.Va,this));this.addEventListener("onPlaybackRateChange",A(this.Wa,this));this.addEventListener("onStateChange",A(this.Xa,this));this.addEventListener("onWebglSettingsChanged",A(this.ab,
this))}
t(hj,ej);n=hj.prototype;n.na=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Si(a)){var d=b;if(Da(d[0])&&!Aa(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Ui.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Ti.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Vi.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Si(a)&&gj(this,this.ga())}};
...
this.f.getVideoUrl());this.f.getVideoContentRect&&(a.videoContentRect=this.f.getVideoContentRect());this.f.getProgressState&&(a.progressState=this.f.getProgressState());this.f.getPlaylist&&(a.playlist=this.f.getPlaylist());this.f.getPlaylistIndex&&(a.playlistIndex=this.f.getPlaylistIndex());this.f.getStoryboardFormat&&(a.storyboardFormat=this.f.getStoryboardFormat());gj(this,a)};
n.Va=function(a){gj(this,{playbackQuality:a})};
n.Wa=function(a){gj(this,{playbackRate:a})};
...
n.Za=function(){gj(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
n.Ya=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:C()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());gj(this,a)};
n.ab=function(){var a={sphericalProperties:this.f.getSphericalProperties()};gj(this,a)};
n.dispose=function(){ej.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function ij(a,b,c){M.call(this);this.f=a;this.i=c;this.j=W(window,"message",A(this.l,this));this.h=new Xi(this,a,b);id(this,Ka(jd,this.h))}
t(ij,M);ij.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
ij.prototype.o=function(){Vf(this.j);this.f=null;M.prototype.o.call(this)};function jj(){var a=cb(kj),b;return Ld(new N(function(c,d){a.onSuccess=function(e){Me(e)?c(e):d(new lj("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new lj("Unknown request error","net.unknown",e))};
a.O=function(e){d(new lj("Request timed out","net.timeout",e))};
b=We("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Md&&b.abort();
return Jd(c)})}
function lj(a,b){E.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
t(lj,E);function mj(){this.g=0;this.f=null}
mj.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Ed(a)?a:nj(a)):2===this.g&&b?(a=b.call(c,this.f),Ed(a)?a:oj(a)):this};
mj.prototype.getValue=function(){return this.f};
mj.prototype.$goog_Thenable=!0;function oj(a){var b=new mj;a=void 0===a?null:a;b.g=2;b.f=void 0===a?null:a;return b}
function nj(a){var b=new mj;a=void 0===a?null:a;b.g=1;b.f=void 0===a?null:a;return b}
;function pj(a){E.call(this,a.message||a.description||a.name);this.isMissing=a instanceof qj;this.isTimeout=a instanceof lj&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Md}
t(pj,E);pj.prototype.name="BiscottiError";function qj(){E.call(this,"Biscotti ID is missing from server")}
t(qj,E);qj.prototype.name="BiscottiMissingError";var kj={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},rj=null;function xe(){if("1"===Xa(pe(),"args","privembed"))return Jd(Error("Biscotti ID is not available in private embed mode"));rj||(rj=Ld(jj().then(sj),function(a){return tj(2,a)}));
return rj}
function sj(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new qj;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new qj;a=a.id;ye(a);rj=nj(a);uj(18E5,2);return a}
function tj(a,b){var c=new pj(b);ye("");rj=oj(c);0<a&&uj(12E4,a-1);throw c;}
function uj(a,b){S(function(){Ld(jj().then(sj,function(c){return tj(b,c)}),xa)},a)}
function vj(){try{var a=z("yt.ads.biscotti.getId_");return a?a():xe()}catch(b){return Jd(b)}}
;function wj(a){if("1"!==Xa(pe(),"args","privembed")){a&&we();try{vj().then(function(){},function(){}),S(wj,18E5)}catch(b){ue(b)}}}
;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function xj(){this.f=Q("ALT_PREF_COOKIE_NAME","PREF");var a=nc.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
n=xj.prototype;n.get=function(a,b){yj(a);zj(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
n.set=function(a,b){yj(a);zj(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
n.remove=function(a){yj(a);zj(a);delete Z[a]};
n.save=function(){lg(this.f,this.dump(),63072E3)};
...
function zj(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
function yj(a){if(!/^\w+$/.test(a))throw Error("ExpectedRegexMismatch: "+a);}
function Aj(a){a=void 0!==Z[a]?Z[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
ya(xj);var Bj=null,Cj=null,Dj=null,Ej={};function Fj(a){var b=a.id;a=a.ve_type;var c=fh++;a=new gh({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Ej[b]=a;b=nh();c=lh();b&&c&&Ih(b,c,[a])}
function Gj(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(qh(b,a),a=lh()))for(var c in Ej){var d=Ej[c];d&&Ih(b,a,[d])}}
function Hj(a){Ej[a.id]=new gh({trackingParams:a.tracking_params})}
function Ij(a){var b=nh();a=Ej[a.id];if(b&&a){a={csn:b,ve:hh(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var c={da:ph(b),P:b};"UNDEFINED_CSN"==b?Jh("visualElementGestured",a,c):hg("visualElementGestured",a,rg,c)}}
function Jj(a){a=a.ids;var b=nh();if(b)for(var c=0;c<a.length;c++){var d=Ej[a[c]];if(d){var e=b;d={csn:e,ve:hh(d),eventType:1};var f={da:ph(e),P:e};"UNDEFINED_CSN"==e?Jh("visualElementShown",d,f):hg("visualElementShown",d,rg,f)}}}
;y("yt.setConfig",P,void 0);y("yt.config.set",P,void 0);y("yt.setMsg",Bg,void 0);y("yt.msgs.set",Bg,void 0);y("yt.logging.errors.log",zg,void 0);
y("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);wj(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";var d=void 0===d?!0:d;b="string"===typeof b?tc(b):b;var e=gi+"_"+Ea(b),f=fi[e];f&&d?a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true")?f.api.loadVideoByPlayerVars(a.args||
null):f.loadNewVideoConfig(a):(f=new Rh(b,e,a,void 0),fi[e]=f,pf("player-added",f.api),id(f,Ka(hi,f)));a=f.api;Bj=a;a.addEventListener("onScreenChanged",Gj);a.addEventListener("onLogClientVeCreated",Fj);a.addEventListener("onLogServerVeCreated",Hj);a.addEventListener("onLogVeClicked",Ij);a.addEventListener("onLogVesShown",Jj);d=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?Dj=new hj(a):Q("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(Cj=new ij(window.parent,d,c),Dj=new cj(a,Cj.h));
c=Q("BG_P",void 0);$g(c)&&(Q("BG_I")||Q("BG_IU"))&&(Wg=!0,Vg.initialize(Q("BG_I",null),Q("BG_IU",null),c,Zg,void 0));Rg()},void 0);
y("yt.www.watch.ads.restrictioncookie.spr",function(a){df(a+"mac_204?action_fcts=1");return!0},void 0);
var Kj=te(function(){Pi("ol");var a=xj.getInstance(),b=!!((Aj("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&nd(document.body,"exp-invert-logo"))if(c&&!nd(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!nd(d,"inverted-hdpi")){var e=ld(d);md(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&nd(document.body,"inverted-hdpi")&&od();b!=c&&(b="f"+(Math.floor(119/31)+1),d=Aj(b)||0,d=c?d|67108864:
d&-67108865,0==d?delete Z[b]:(c=d.toString(16),Z[b]=c.toString()),a.save())}),Lj=te(function(){var a=Bj;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Vg.dispose();a=0;for(var b=Pg.length;a<b;a++){var c=Pg[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):T(c)}}Pg.length=0;Ng("//static.doubleclick.net/instream/ad_status.js");Qg=!1;P("DCLKSTAT",0);kd(Dj,Cj);if(a=Bj)a.removeEventListener("onScreenChanged",Gj),a.removeEventListener("onLogClientVeCreated",Fj),a.removeEventListener("onLogServerVeCreated",Hj),a.removeEventListener("onLogVeClicked",Ij),a.removeEventListener("onLogVesShown",
Jj),a.destroy();Ej={}});
window.addEventListener?(window.addEventListener("load",Kj),window.addEventListener("unload",Lj)):window.attachEvent&&(window.attachEvent("onload",Kj),window.attachEvent("onunload",Lj));La("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||ah);La("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||bh);La("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||Sg);
La("yt.player.exports.navigate",z("yt.player.exports.navigate")||rh);La("yt.util.activity.init",z("yt.util.activity.init")||cg);La("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||fg);La("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||dg);}).call(this);
