...
FenPrincipale::FenPrincipale()
{
    ...
    //génénération des widgets de la fenetre principale
    ...
    //définition de quelques propriétés de la fenetre
...
QWidget *FenPrincipale::creerOngletsPageWeb(QString url)
{
   QWidget *pageOnglet = new QWidget;
   QWidget *pageWeb = new QWebView;
   ...
   if (url.isEmpty())
   {
       pageWeb->load(QUrl(tr("htlm/pageblanche.html")));
...
{
    return onglet->currentWidget()->findChild<QWebView *>();
}
...
void FentrePrincipale::actualiser()
{
   pageActuelle()->reload();
...
{
    QMessageBox::information(this, tr("A propos...", tr("zNavigo est un projet réalisé pour illuster les tutoriels du <a href=\"http://www.openclassroom.com\">Site du zero</a>.<br/> Les images de ce programme ont été crées par <a href=\"http://www.everaldo.com\">Everaldo Coelho</a>"));
}
...
void FenPrincipale::changementTitre(const QString & titreComplet)
{
    ...
    //tronquage de titre pour eviter des onglets trop larges
